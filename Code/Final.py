...
class FinalSentenceRepresentation(Layer):
    ...
    def __init__(self,
        ...
        super(FinalSentenceRepresentation, self).__init__(**kwargs)
    ...
    def call(self, inputs):
        ...
        x = inputs[0]
        t = inputs[1]
        print("r",x.shape)     # (1,300)
       
   
        print("H_last",t.shape)  #(64,300)
        
        m_1 = K.dot(x,self.Wp)  # output= ( 1,300)
        print("m1 ",m_1.shape)
        
        m_2 = K.dot(t , self.Wx)     # (64,300)
